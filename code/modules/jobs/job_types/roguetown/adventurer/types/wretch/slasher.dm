...
/datum/outfit/job/roguetown/wretch/slasher/pre_equip(mob/living/carbon/human/H)
	...
	if(H.mind)
		...
		var/specialization = list("Fast (Dodge Expert, Sneaking, +1 SPD)", "Strong (No Pain, Blood Resistance, +1 STR)") //thank you outlaw coders i love you mwah
		...
		switch(specialization_choice)
			...
			if("Strong (No Pain, Blood Resistance, +1 STR)")
