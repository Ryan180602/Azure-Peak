...
/datum/outfit/job/roguetown/confessor/choose_loadout(mob/living/carbon/human/H)
	. = ..()
	var/melee_weapons = list("Shortsword", "Handmace", "Dagger")
	var/weapon_choice = input(H,"Choose your PSYDONITE weapon.", "TAKE UP PSYDON'S ARMS") as anything in melee_weapons
	...
	var/ranged_weapons = list("Slurbow", "Crossbow")
	var/weapon_choice = input(H,"Choose your PSYDONITE weapon.", "TAKE UP PSYDON'S ARMS") as anything in ranged_weapons
	switch(weapon_choice)
		if("Slurbow")
