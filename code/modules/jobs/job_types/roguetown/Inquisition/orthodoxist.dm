/datum/job/roguetown/orthodoxist
	...
	tutorial = "Praise. Atone. Mourn. A hundred different paths across a hundred different lyves, all ending the same; \
	with you swearing fealty to Psydon, and your admittance into the Inquisitor's retinue. \
	Root the abberants out from wherever they dwell, and - whether with a clenched fist or open palm - \
